...
pjdir="/scratch/qm89/Jinglei_Projects/Tract_ID_system"
tmpdir="/scratch/qm89/Jinglei_Projects/tmp"
mkdir $pjdir/HCP_f100
wkdir=$pjdir/HCP_f100
...
rm -f ${dwidir}/data.nii.gz
rm -f ${dwidir}/data.mif
rm -f ${dwidir}/cDWI.mif
rm -f ${dwidir}/b0_CDWI_up.mif
rm -f ${dwidir}/cDWI_upsampled.mif
